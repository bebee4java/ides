                        ...
                        return n("div", {
                            ...
                            [n("div", {
                                ...
                                t._l(t.columns,
                                    function(e, o) {
                                        return n("div", {
                                                staticClass: "div-table-col"
                                            },
                                            [t._v(t._s(e))])
                                    })), t._v(" "), t._l(t.tableData,
                                function(e, o) {
                                    return n("div", {
                                            staticClass: "div-table-row"
                                        },
            ...
            var c = n("VU/8")({
                ...
                p = function() {
                    ...
                    return _()(t, [{
                        ...
                        value: function() {
                            var e = {
                                identifierRegexps: [/[^\s]+/],
                                getCompletions: function(e, n, o, r, s) {
                ...
                k = function() {
                    ...
                    return _()(t, [{
                        ...
                        value: function() {
                            this._holder,
                                this._holder.editor().getSession()
                        }
                    },
                        {
                            key: "getTrainLine",
                            value: function() {
                                var t = this._holder.ace().acequire("ace/range").Range,
                                    e = this._holder.editor(),
                                    n = e.getSession(),
                                    o = e.getCursorPosition(),
                                    r = n.getTextRange(new t(0, 0, o.row, o.column));
                                console.log(y(r).split(";")),
                                    console.log(r)
                            }
                        },
                        {
                    ...
                    return _()(t, [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return t.http.post(t.resource.stream_jobs_url, {},
                                    n).then(function(o) {
                                        var r = T.groupBy(o.data, "owner");
                                        for (var s in r) T.formatStartTime(r[s]),
                                            e.push({
                                                owner: s,
                                                jobs: r[s]
                                            });
                                        t.http.post(t.resource.batch_jobs_url, {},
                                            n).then(function(t) {
                                                var n = T.groupBy(x()(t.data), "owner");
                                                for (var o in n) T.formatStartTime(n[o]),
                                                    e.push({
                                                        owner: o,
                                                        jobs: n[o]
                                                    })
                    ...
                    methods: {
                        ...
                        submitRunSQL: function(t) {
                            ...
                            e.jobName = L(),
                                ...
                                e.result.columns = [],
                                e.result.msg = "";
                            var n = e.holder.tool().selection(),
                                o = e.content;
                            "" != n && (o = n);
                            var r = new R(e.$http).submitJob({
                                    sql: o,
                                    owner: "admin",
                                    jobName: e.jobName
                                },
                            ...
                            e.result.columns = r.columns,
                                e.result.tableData = r.tableData
                        }
                    },
                    components: {
                        editor: n("o4sT"),
                ...
                E = {
                    render: function() {
                        var t = this,
                            ...
                            n = t._self._c || e;
                        return n("div", {
                                staticClass: "query_box"
                            },
                            [n("div", {
                                    staticClass: "editor_mode_select"
                                },
                                [n("span", [t._v("编辑器模式")]), t._v(":\n    "), n("vSelect", {
                                    attrs: {
                                        options: t.result.editor_modes
                                    },
                                    model: {
                                        value: t.result.editor_mode_selected,
                                        callback: function(e) {
                                ...
                                [n("editor", {
                                    ...
                                    [t._v("任务列表")])]), t._v(" "), t.result.loading ? n("vloading") : t._e()], 1), t._v(" "), n("div", {
                                    attrs: {
                                        id: "show_result"
                                    }
                                },
                                ["" != t.result.msg ? n("editor", {
                                    attrs: {
                                        lang: "text",
                                        width: "100%",
                                        height: "100px"
                ...
                q = {
                    ...
                    methods: {
                        killJob: function(t, e) {
                            ...
                            n.killJob(t, e),
                                this.usersWithJobs = n.fetchJobs()
                        },
                ...
                D = {
                    render: function() {
                        var t = this,
                            ...
                            n = t._self._c || e;
                        return n("div", {
                                staticClass: "stream-jobs-list"
                            },
                            [t._m(0), t._v(" "), t._l(this.usersWithJobs,
                                function(e) {
                                    return n("div", {
                                            staticClass: "job-boarder"
                                        },
                                        [n("header", [t._v("用户:" + t._s(e.owner))]), t._v(" "), t._l(e.jobs,
                                            function(e) {
                                                return n("div", {
                                                        staticClass: "job-card-detail"
                                                    },
                                                    [n("div", {
                                                            staticClass: "job-item"
                                                        },
                                                        [n("span", [t._v(t._s(e.jobName))]), t._v(" "), n("div", {
                                                                staticClass: "job-item-content"
                                                            },
                                                            [t._v("任务类型：" + t._s(e.jobType))]), t._v(" "), n("div", {
                                                                staticClass: "job-item-content"
                                                            },
                                                            [t._v("任务内容：" + t._s(e.jobContent))]), t._v(" "), n("div", {
                                                                staticClass: "job-item-content"
                                                            },
                                                            [t._v("任务启动时间：" + t._s(e.startTime))]), t._v(" "), n("button", {
                                                                on: {
                                                                    click: function(n) {
