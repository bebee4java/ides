 ...
 * 参考 org.apache.spark.internal.config.ConfigEntry
 *
 ...
 */
private[conf] abstract class ConfigEntry[T] (
                                               val key: String,
 ...
 */
private[conf] class OptionalConfigEntry[T](
                                             key: String,
                                             prependedKey: Option[String],
                                             prependSeparator: String,
                                             alternatives: List[String],
 ...
 */
private[conf] class FallbackConfigEntry[T] (
                                              key: String,
                                              prependedKey: Option[String],
                                              prependSeparator: String,
                                              alternatives: List[String],
...
private[conf] object ConfigEntry {

  val UNDEFINED = "<undefined>"

  private[conf] val knownConfigs =
